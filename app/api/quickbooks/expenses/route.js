...
// ── IRS Mileage Rate ───────────────────────────────────────────
const IRS_MILEAGE_RATE_2026 = 0.70; // 2026 standard rate (update annually)

// ── Expense categories for personal training ───────────────────
const EXPENSE_CATEGORIES = {
  gas: ["Fuel", "Gas", "Gasoline", "Shell", "Chevron", "BP", "Exxon", "Wawa", "Costco Gas"],
  vehicle: ["Car", "Auto", "Vehicle", "Oil Change", "Tire", "Maintenance", "Insurance - Auto"],
  equipment: ["Equipment", "Weights", "Bands", "Mat", "Fitness", "Amazon", "Rogue"],
  marketing: ["Marketing", "Advertising", "Meta", "Google Ads", "Canva", "Website", "Domain"],
  insurance: ["Insurance", "Liability", "Policy"],
  software: ["Software", "Subscription", "Acuity", "QuickBooks", "Stripe Fee"],
  other: [],
};
...
export async function GET(request) {
  ...
  try {
    ...
    const estimatedGallons = gasTotal / 3.50; // avg gas price estimate
    const estimatedMiles = estimatedGallons * 25; // avg MPG estimate
    const mileageDeduction = Math.round(estimatedMiles * IRS_MILEAGE_RATE_2026 * 100) / 100;
