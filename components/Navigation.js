...
export default function Navigation() {
  ...
  return (
    <>
      ...
      <nav
        className={`fixed top-0 left-0 h-full w-64 bg-navy-500 border-r border-navy-400/20 z-40 transform transition-transform duration-200 ${
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-navy-400/20">
          <div className="text-xs text-navy-100/40 uppercase tracking-wider font-heading">
            Current Phase
          </div>
          <div className="text-sm font-medium text-brand-500 font-heading">
            Phase 1 — Build Foundation
          </div>
          <div className="text-xs text-navy-100/50 mt-1">
            2026 Target: $108K
          </div>
          <button
...
function BarChartIcon({ active }) {
  return (
    <svg
      className={`w-5 h-5 ${active ? "text-brand-500" : ""}`}
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
    >
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M9 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m3-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12l3-2 3 2 3-2 3 2z"
      />
    </svg>
  );
}
